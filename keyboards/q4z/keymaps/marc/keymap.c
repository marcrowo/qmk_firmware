...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT(
   ...
   KC_NO, KC_NO, MO(NAV), KC_LSFT, KC_SPC, MO(SYM), TG(GAME), KC_SLSH
  ),
  ...
  [GAME] = LAYOUT(
    ...
    KC_TILD, KC_A, KC_S, KC_D, KC_F, KC_G, KC_NO, KC_NO, KC_NO, KC_NO,
    KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_NO, KC_NO, KC_NO,
    KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_SPC, KC_NO, TG(GAME), KC_NO
  ),
};
