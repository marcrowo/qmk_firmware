...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [SYM] = LAYOUT(
    KC_ESC,   KC_LBRC,  KC_LCBR, KC_LPRN, KC_TILD, KC_TRNS, KC_CIRC, KC_RPRN, KC_RCBR, KC_RBRC, KC_GRV,
    KC_MINUS, KC_ASTR,  KC_EQL,  KC_UNDS, KC_DLR,           KC_HASH, OS_GUI,  OS_ALT,  OS_CTRL, OS_SHFT,
    KC_PLUS,  KC_PIPE,  KC_AT,   KC_QUOT, KC_DQUO,          KC_NO,   KC_PERC, KC_BSLS, KC_AMPR, KC_EXLM,
    // THUMB ROW
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
  ),
  [NAV] = LAYOUT(
    KC_TAB,  KC_VOLD, KC_MUTE, KC_VOLU, KC_NO, KC_TRNS, RESET,  KC_HOME,  KC_UP,   KC_END,  KC_BSPC,
    OS_SHFT, OS_CTRL, OS_ALT,  OS_GUI,  KC_NO,          KC_CAPS, KC_LEFT, KC_DOWN, KC_RGHT, KC_ENTER,
    KC_NO,   KC_MPRV, KC_MPLY, KC_MNXT, KC_NO,          KC_NO,   KC_PGDN, KC_NO,   KC_PGUP, KC_DEL,
    // THUMB ROW
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
  ),
  [NUM] = LAYOUT(
