...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT(
   ...
   KC_NO, TO(GAME), MO(NAV), KC_SPC, KC_LSFT, MO(SYM), KC_NO, KC_SLSH
  ),
  ...
  [NAV] = LAYOUT(
    ...
    KC_ESC,  KC_VOLD, KC_MUTE, KC_VOLU, KC_NO, KC_NO,   KC_HOME,  KC_UP,   KC_END,  KC_BSPC,
  ...
  [GAME] = LAYOUT(
    KC_1, KC_2, KC_3, KC_4, KC_5,
    KC_TILD, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_6, KC_UP, KC_NO, KC_P,
    KC_TAB, KC_A, KC_S, KC_D, KC_F, KC_G, KC_LEFT, KC_DOWN, KC_RIGHT, KC_NO,
    KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_NO, KC_NO, KC_NO,
    KC_LCTL, KC_NO, KC_LALT, KC_SPC, KC_ESC, KC_NO, TO(BASE), KC_NO
  ),
};
