...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [EXTEND] = LAYOUT(
    ...
    OSM(MOD_LSFT), OSM(MOD_LCTL), OSM(MOD_LGUI), OSM(MOD_LALT), KC_NO,          KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_DEL,
    KC_TAB,        KC_MRWD,       KC_MPLY,       KC_MFFD,       KC_NO,          KC_ENT,  KC_BSPC, KC_NO,   KC_NO,   KC_NO,
    // THUMB ROW
